...
$dockerContainerName = "ticketbot"
$remoteProjectName = "TicketBot"  # 远程服务器上项目目录的名称
...
$zipFileName = "ticketbot_deploy_$timestamp.zip"
...
try
{
    ...
    Write-Host "🎉 部署成功完成！TicketBot 已在服务器上更新并启动。" -ForegroundColor Green
